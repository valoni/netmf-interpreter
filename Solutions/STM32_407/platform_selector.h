...
#ifndef _PLATFORM_STM32_407_SELECTOR_H_
#define _PLATFORM_STM32_407_SELECTOR_H_
...
#if defined(PLATFORM_ARM_STM32_407)
#define HAL_SYSTEM_NAME "STM32_407"
...
#define STM32F4_UART_RXD_PINS {10, 23, 54, 43}                                   //PA10, PB7, D6, C11
#define STM32F4_UART_TXD_PINS {9 , 22, 53, 42}                                   //PA9, PB6, D5, C10
#define STM32F4_UART_CTS_PINS {(BYTE)GPIO_PIN_NONE,(BYTE)GPIO_PIN_NONE, 51, 59}   //GPIO_PIN_NONE, GPIO_PIN_NONE, D3, D11
#define STM32F4_UART_RTS_PINS {(BYTE)GPIO_PIN_NONE,(BYTE)GPIO_PIN_NONE, 52, 60}   //GPIO_PIN_NONE, GPIO_PIN_NONE, D4, D12

// User LEDs
#define LED3 PORT_PIN(GPIO_PORTE, 0) // PD.13 (orange)
#define LED4 PORT_PIN(GPIO_PORTE, 0) // PD.12 (green)
#define LED5 PORT_PIN(GPIO_PORTE, 0) // PD.14 (red)
#define LED6 PORT_PIN(GPIO_PORTE, 0) // PD.15 (blue)

// TinyBooter entry using GPIO
#define TINYBOOTER_ENTRY_GPIO_PIN       PORT_PIN(GPIO_PORTD, 15) // 'User' button
...
#endif // PLATFORM_ARM_STM32_407

#endif // _PLATFORM_STM32_407_SELECTOR_H_
